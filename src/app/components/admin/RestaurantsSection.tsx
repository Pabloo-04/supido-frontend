...
import { fetchAllRestaurants, deleteRestaurant, type MenuItem, type Restaurant } from "@/lib/admin";
...
export default function RestaurantsSection() {
  ...
  function handleRestaurantUpdated(r: Restaurant) {
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        <button
                            ...
                            style={{ fontFamily: "var(--font-dm)" }}
                        >
                          {expandedMenuId === r.id ? "Cerrar" : "+ Ítem"}
                        </button>
                        ...
                        <button
                            ...
                            className="text-xs font-medium text-red-400 hover:text-white hover:bg-red-500
                               px-3 py-1.5 rounded-full border border-red-400/30
