...
export default function AddRestaurantForm({ onCreated, onCancel }: Props) {
  ...
  const fields: { name: keyof typeof INITIAL; label: string; placeholder: string; required?: boolean }[] = [
    { name: "name",        label: "Nombre",          placeholder: "Nombre del restaurante", required: true },
    { name: "category",    label: "Categoría",        placeholder: "Ej: Pizzas, Sushi…",    required: true },
